...
func interact(conn *net.TCPConn) {
	...
	for {
		...
		case "solve":
			...
			fmt.Printf("\033[38;5;141ma = \u001B[38;5;213m")
			frac.A = input.Gets()
			fmt.Printf("\033[38;5;141mb = \u001B[38;5;213m")
			frac.B = input.Gets()

			send_request(encoder, "solve", &frac)
		case "res":
